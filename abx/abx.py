...
with gr.Blocks() as app:
    ...
    # Top instructions + Clear / Loop buttons
    ...
    gr.Markdown(
        ...
        "The Clear / Loop buttons above are kept only for layout in this version and "
        "do not affect the scores."
    )
    with gr.Row():
        clear_btn = gr.Button("Clear region")
        loop_btn = gr.Button("Looping OFF")
